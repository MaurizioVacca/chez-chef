        ...
        , section [ Html.Attributes.class "col-span-12 lg:col-span-8 order-1 lg:order-2" ]
            [ header []
                ...
                , div [ Html.Attributes.class "flex py-4 border-b-1 border-b-amber-900" ]
                    ...
                    , button
                        [ Html.Attributes.class "ml-auto cursor-pointer text-pink-700"
                        , Html.Attributes.attribute "data-cy" "favourite-toggle"
                        , Html.Events.onClick (SharedMsg (ToggleFavourite asOverview))
                        ]
                        [ icon ]
                    ]
                ]
